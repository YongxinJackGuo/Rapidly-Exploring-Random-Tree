...
if(lynx.firstFrame) %We need to create the plots
    ...
    if(lynx.showFrame)
        ...
        lynx.hEExAxis = line([T0e(1,4),T0e(1,4)+EExAxis(1)],[T0e(2,4),T0e(2,4)+EExAxis(2)],[T0e(3,4),T0e(3,4)+EExAxis(3)],'Color','r','LineWidth',axisWidth);
        lynx.hEEyAxis = line([T0e(1,4),T0e(1,4)+EEyAxis(1)],[T0e(2,4),T0e(2,4)+EEyAxis(2)],[T0e(3,4),T0e(3,4)+EEyAxis(3)],'Color','g','LineWidth',axisWidth);
        lynx.hEEzAxis = line([T0e(1,4),T0e(1,4)+EEzAxis(1)],[T0e(2,4),T0e(2,4)+EEzAxis(2)],[T0e(3,4),T0e(3,4)+EEzAxis(3)],'Color','b','LineWidth',axisWidth);
    end
    ...
    if(lynx.showFrame)
        ...
        EEyAxis = frameSize*EEyAxis;
        EEzAxis = frameSize*EEzAxis;
        set(lynx.hEExAxis,'xdata',[T0e(1,4),T0e(1,4)+EExAxis(1)],'ydata',[T0e(2,4),T0e(2,4)+EExAxis(2)],'zdata',[T0e(3,4),T0e(3,4)+EExAxis(3)]);
        set(lynx.hEEyAxis,'xdata',[T0e(1,4),T0e(1,4)+EEyAxis(1)],'ydata',[T0e(2,4),T0e(2,4)+EEyAxis(2)],'zdata',[T0e(3,4),T0e(3,4)+EEyAxis(3)]);
        set(lynx.hEEzAxis,'xdata',[T0e(1,4),T0e(1,4)+EEzAxis(1)],'ydata',[T0e(2,4),T0e(2,4)+EEzAxis(2)],'zdata',[T0e(3,4),T0e(3,4)+EEzAxis(3)]);
    end
